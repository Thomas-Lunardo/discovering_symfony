 ...
 */
final class Version20231130110034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season ADD program_id INT NOT NULL, CHANGE number number INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season DROP program_id, CHANGE number number INT DEFAULT NULL');
    }
}
