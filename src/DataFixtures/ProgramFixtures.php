...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    public const PROGRAMES = [
        ...
        ['title' => 'Transformers: Rise of the Beasts', 'synopsis' => 'Il suit à nouveau un groupe de Decepticons et d\'Autobots qui s\'affrontent dans une guerre entre ceux qui veulent contrôler la planète et ceux qui veulent vivre en communion.', 'category' => 'category_Sicence-fiction', 'poster' => 'build/images/breaking_bad.bde4b71b.png',],
