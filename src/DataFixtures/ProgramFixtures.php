...
class ProgramFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public const PROGRAMES = [
        ...
        ['title' => 'Hunger Games', 'synopsis' => 'Katniss Everdeen se porte volontaire pour prendre la place de sa jeune soeur aux Hunger Games, une compétition télévisée au cours de laquelle deux adolescents de chacun des douze districts de Panem sont choisis au hasard pour se battre jusqu\'à la mort.', 'category' => 'category_Action', 'poster' => 'build/images/hunger_games.65c5f0f7.png', 'country' => 'United-States', 'year' => '2009',],
        ['title' => 'Napoléon', 'synopsis' => 'Offre un aperçu personnel des origines de Napoléon et de son ascension rapide et impitoyable vers l\'empire, vu à travers le prisme de sa relation addictive et souvent volatile avec sa femme et son véritable amour, Joséphine.', 'category' => 'category_Biopic', 'poster' => 'build/images/napoleon.cbe2c0c6.png', 'country' => 'United-States', 'year' => '2009',],
